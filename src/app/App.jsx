...
export default function App() {
  ...
  function handleLoginSuccess(selectedProfile) { saveAccessProfile(selectedProfile); setProfile(selectedProfile); navigateTo('/home'); }
  function handleLogout() { clearAccessProfile(); setProfile(null); navigateTo('/login'); }
